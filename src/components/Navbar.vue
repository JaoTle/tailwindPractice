<template>
    <div>
        <nav class="border-b-2">
            <div class="sm:w-full md:w-935 lg:w-935 mx-auto">
                <div class="flex justify-between flex-col sm:flex-col md:flex-row lg:flex-row h-32 md:h-16 py-2 items-center">
                    <div class="logo">
